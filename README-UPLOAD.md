...
3. Rozbal tento ZIP.
4. Zkopíruj veškerý obsah ZIPu (včetně skrytých souborů `.gitignore` a `.env.example`) do složky repozitáře.
...
- Environment Variables:
  ...
  - (volitelně SMTP – viz `.env.example`)

Render Render při buildu sám stáhne `node_modules` a postaví `dist/`. Není potřeba nic předbuildovaného.

Podrobnosti viz `README.md`.
